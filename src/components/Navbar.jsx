        ...
        <div className="flex items-center justify-between h-16">
          <div className="flex-shrink-0">
            <a 
              ...
              className="text-2xl font-bold text-cyan-400 tracking-wider cursor-pointer"
            >
              PORTFOLIO
            </a>
          </div>
            ...
            <div className="ml-10 flex items-baseline space-x-4">
              {navLinks.map((link) => (
                <a
                  ...
                  className="text-gray-300 hover:text-cyan-400 hover:bg-slate-800 px-3 py-2 rounded-md text-sm font-medium transition-colors duration-300 cursor-pointer"
                >
                  {link.name}
                </a>
              ))}
